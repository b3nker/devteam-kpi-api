...
public class GoogleSheetsAPI {
    private static final String SPREADSHEET_ID = "10sejSG58ufu9m5i-uJg4bzrFF_f3NEnzSX5TLAnIhxU";
    private static final String RANGE = "Absences été!A1:BP45"; // NOM_FEUILLE!CASE_DEP:CASE_FIN
    private static final String APPLICATION_NAME = "Test API";
